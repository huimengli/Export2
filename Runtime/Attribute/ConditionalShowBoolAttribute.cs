...
namespace Export.Attribute
{
    ...
    ///     [ConditionalShowBool("currentWeapon", true)]
    ///     public int arrowCount;
    ///     [ConditionalShowBool("currentWeapon", false)]
    ...
    public class ConditionalShowBoolAttribute : PropertyAttribute
    {
        ...
        public ConditionalShowBoolAttribute(string conditionalSourceField,bool showValue)
        {
